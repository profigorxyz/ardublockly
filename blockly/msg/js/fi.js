...
Blockly.Msg.ARD_INCLUDE = "Include library file";  // untranslated
Blockly.Msg.ARD_INCLUDE_TIP = "Include library file, dont forget to copy file to arduino library folder.";  // untranslated
...
Blockly.Msg.ARD_MOTORS_298N_EN = "PWM PIN";  // untranslated
Blockly.Msg.ARD_MOTORS_298N_ID = "ID";  // untranslated
Blockly.Msg.ARD_MOTORS_298N_INI_TITLE = "298N Init";  // untranslated
Blockly.Msg.ARD_MOTORS_298N_MAD = "MA DIR PIN";  // untranslated
Blockly.Msg.ARD_MOTORS_298N_MBD = "MB DIR PIN";  // untranslated
Blockly.Msg.ARD_MOTORS_298N_TITLE = "298N Control";  // untranslated
Blockly.Msg.ARD_MOTORS_298SHIELD_TIP = "298 Motor Shield A and B (no brake/current)";  // untranslated
Blockly.Msg.ARD_MOTORS_298SHIELD_TITLE = "298 Shield Control";  // untranslated
Blockly.Msg.ARD_MOTORS_AFDC = "Adafruit Motor Shield DC";  // untranslated
Blockly.Msg.ARD_MOTORS_AFST = "Adafruit Motor Shield Stepper";  // untranslated
Blockly.Msg.ARD_MOTORS_B = "Backward";  // untranslated
Blockly.Msg.ARD_MOTORS_BR = "Break";  // untranslated
Blockly.Msg.ARD_MOTORS_CON = "Connected to";  // untranslated
Blockly.Msg.ARD_MOTORS_DC = "DC Motor";  // untranslated
Blockly.Msg.ARD_MOTORS_DC_SPEED = "Speed [0-255]";  // untranslated
Blockly.Msg.ARD_MOTORS_DC_SPEEDA = "MA Speed [0-255]";  // untranslated
Blockly.Msg.ARD_MOTORS_DC_SPEEDB = "MB Speed [0-255]";  // untranslated
Blockly.Msg.ARD_MOTORS_DIR = "Direction";  // untranslated
Blockly.Msg.ARD_MOTORS_F = "Foward";  // untranslated
Blockly.Msg.ARD_MOTORS_L = "Left";  // untranslated
Blockly.Msg.ARD_MOTORS_R = "Right";  // untranslated
Blockly.Msg.ARD_MOTORS_S = "Stop";  // untranslated
Blockly.Msg.ARD_MOTORS_STEPPER = "Stepper Motor";  // untranslated
Blockly.Msg.ARD_MOTORS_STEPPER_CON = "Connect to";  // untranslated
Blockly.Msg.ARD_MOTORS_STEPPER_RPM = "Speed(RPM)";  // untranslated
Blockly.Msg.ARD_MOTORS_STEPPER_SPR = "Steps per revolution";  // untranslated
Blockly.Msg.ARD_MOTORS_STEPPER_STEPS = "Move to Step";  // untranslated
...
Blockly.Msg.ARD_SENSORS_ISBLACK_PIN = "Is dark bellow the sensor in pin:";  // untranslated
Blockly.Msg.ARD_SENSORS_SONAR_EPIN = "echo pin";  // untranslated
Blockly.Msg.ARD_SENSORS_SONAR_TPIN = "Distance in cm, trig pin";  // untranslated
